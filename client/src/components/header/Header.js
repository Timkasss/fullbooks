   ...
   return (
      <header className="header">
         <div className="header__container">
            <div className="header__adaptive">
               <div className="header__logo-wrapper">
                  ...
                  <div className="header__social-wrapper">
                     <a href="telegram.com" className="header__social">
                     ...
                     <a href="instagram.com" className="header__social">
            ...
            <div className="header__menu-adaptive header__menu-adaptive_visible">
               <Menu />
            </div>
