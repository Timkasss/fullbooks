      ...
      <div className="footer">
         <div className="footer__container">
            <header className="footer__header">
               <a href="#" className="footer__header-link">
            ...
            <footer className="footer__footer">
               <p className="footer__law">2020 © Kinoarea.  Все права защищены</p>
               <a href="#" className="footer__footer-link">Политика конфиденциальности</a>
            </footer>
         </div>
      </div>
   )
