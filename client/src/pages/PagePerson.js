         ...
         <section className="page-person">
            <div className="page-person__container-small">
               <div className="page-person__header-wrapper">
                  ...
                  <h1 className="page-person__header-title">{author.fullname}</h1>
                  <p className="page-person__header-subtitle"></p>
               </div>
               <div className="page-person__wrapper-img">
                  <img src={author.image} alt="person" className="page-person__image" />
               </div>
