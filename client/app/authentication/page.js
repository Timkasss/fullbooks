...
//import Restore from "../ui/header/login/Restore";
    ...
    <div className={styles.wrapper}>
      <div className={styles.model}>
        ...
        <form className={styles.loginFormWrapper}>
          ...
          />
          <button className={styles.formEnter} type="submit">
            Увійти
          </button>
        </form>
        ...
        <div
          ...
          // onClick={() => setModelRestoreOne(!modelRestoreOne)}
        >
          Відновити пароль
        </div>
        {/* {modelRestoreOne && <Restore setRestore={setModelRestoreOne} />} */}
