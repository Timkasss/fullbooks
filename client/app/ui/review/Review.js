...
import avatar from '@/public/img/book/avatar.png';
      ...
      <article className={styles.review}>
         <header className={styles.header}>
            ...
            <div className={styles.personData}>
               <div className={`${styles.reviews} ${styles.review_name}`}>Рецензії<span className={styles.count}>(113)</span></div>
               <div className={`${styles.grade} ${styles.review_name}`}>Оцінки<span className={styles.count}>(13)</span></div>
               <div className={`${styles.friends} ${styles.review_name}`}>Друзі<span className={styles.count}>(3)</span></div>
               <div className={`${styles.books} ${styles.review_name}`}>Книги<span className={styles.count}>(1)</span></div>
               <div className={`${styles.writer} ${styles.review_name}`}>Письменики<span className={styles.count}>(11)</span></div>
            </div>
         ...
         <footer className={styles.footer}>
            <div className={styles.commentLinkWrapper}>
               <div className={styles.footerCommeting}>Коментувати</div>
               <a href="#" className={styles.footerLink}>Пряме посилання</a>
            </div >
            <div className={styles.foterComplain}>Поскаржитися на спойлер</div>
         </footer>
      </article>
   )
}
