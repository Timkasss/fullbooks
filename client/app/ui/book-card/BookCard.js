...
export default function BookCard({ databook }) {
            ...
            <div className={styles.container}>
               <div className={styles.wrapper}>
                  <div className={styles.mainBlock}>
                     ...
                     <p className={styles.subTitle}>{surName}</p>
                     ...
                     <div className={styles.wrapperLinks}>
                        <div className={styles.read}>
                           <a href="#" className={styles.readLink}>Читати</a>
                        </div>
                  ...
                  <div className={styles.grade}>
                     ...
                     <div className={styles.favoritesWrapper}>
                        ...
                        <div className={styles.favoritesText}>В избранном у <span>37933</span> человек </div>
                     </div>
                  </div>
               </div>
               <table id={styles.table}>
                  {/* <tbody className='table-adapt'> */}
                  <tbody className={styles.tableAdaptOne}>
                     <tr>
                        <th>Рік</th>
                        <td>{year}</td>
                     </tr>
                  ...
                  <tbody className={styles.tableAdaptTwo}>
                     <tr>
                        <th>Видавництво</th>
                        <td>{publishing}</td>
                     </tr>
