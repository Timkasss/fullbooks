...
export default function AddAuthor({ openModel }) {
   ...
   return (
      <form className={styles.formAuthor} onClick={(e) => e.stopPropagation()} action={addAuthor}>
         ...
         <div className={styles.wrapInputs}>
            ...
            <div>
               <label htmlFor="first-name" className={styles.titleInput}>Full Name</label>
               <input type="text" placeholder="First Name" className={styles.input} id="first-name" name="fullname" />
            </div>
            <div>
               <label htmlFor="type-activity" className={styles.titleInput}>Type activity</label>
               <input type="text" placeholder="Type activity" className={styles.input} id="type-activity" name="typeactivity" />
            </div>
            ...
            <div>
               ...
               <input type="date" placeholder="Date born" className={styles.input} id="date-born" name="birthday" />
            </div>
            <div>
               <label htmlFor="date-dead" className={styles.titleInput}>Date dead</label>
               <input type="date" placeholder="Date dead" className={styles.input} id="date-dead" name="deathdate" />
            </div>
            <div>
               <label htmlFor="place-born" className={styles.titleInput}>Place born</label>
               <input type="text" placeholder="Place born" className={styles.input} id="place-born" name="placeofbirth" />
            </div>
            <div>
               <label htmlFor="place-dead" className={styles.titleInput}>Place dead</label>
               <input type="text" placeholder="Place dead" className={styles.input} id="place-dead" name="placeofdeath" />
            </div>
            <div>
               <label htmlFor="genre" className={styles.titleInput}>Genre</label>
               <Select name="genre" options={genre} id="genre" styles={{
            ...
            <div>
               ...
               <Select name="direction" options={direction} id="direction" styles={{
                  control: (baseStyles, state) => ({
                     ...baseStyles,
                     minHeight: "34px",
                     color: "#222B45",
            ...
            <div>
               ...
               <select name="languageworks" placeholder="Select language" className={styles.input} id="language" >
         ...
         <div className={styles.buttons}>
            <button className={styles.addButton} type="submit">Add Author</button>
