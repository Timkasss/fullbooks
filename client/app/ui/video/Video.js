...
import poster1 from '@/public/img/video/video1.png';
import poster2 from '@/public/img/video/video2.png';
import poster3 from '@/public/img/video/video3.png';
import poster4 from '@/public/img/video/video4.png';
      ...
      <section className={styles.video}>
         <div className={styles.container}>
            <div className={styles.header}>
               <h1 className={`${styles.title} ${styles.section_title}`}>Новые трейлеры</h1>
               <a href="#" className={styles.allVideo}>Все трейлеры</a>
            </div>
            <div className={styles.bigVideoWrapper}>
               <section className={styles.mainVideo}>
                  <footer className={styles.footer}>
                     <div className={styles.footerLeft}>
                        <h1 className={styles.bigTitle}>{videos[video].name}</h1>
                     ...
                     <div className={styles.grade}>
                        <div className={styles.gradeLike} onClick={like}>
                           ...
                           <span className={styles.likeCount}>{countGrade[video].like}</span>
                        </div>
                        <div className={styles.gradeDislike} onClick={dislike}>
                           ...
                           <span className={styles.dislikeCount}>{countGrade[video].dislike}</span>
                        </div>
                     </div>
                  </footer>
               ...
               <div className={styles.listWrapper}>
                  <div className={styles.listContainer}>
                     <Swiper
                        ...
                        className={styles.mySwiperVideo}>
                        {
                           videos.map((item, index) => {
                              return (
                                 <SwiperSlide key={index}>
                                    <article className={styles.item}>
                                       <div className={styles.itemWrapper} onClick={() => setVideo(index)}>
                                          <Image
                                             className={styles.smallVideo}
                                             width={500}
                                             height={500}
                                             src={item.img} alt="poster" />
