...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1(userModel, jwtService, imageService) {
        ...
        UsersService_1.prototype.update = function (id, updateUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, image, password, updatedUser, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 5, , 6]);
                        ...
                        case 1:
                            ...
                            if (!user)
                                throw new common_1.NotFoundException('User not found');
                            return [4 /*yield*/, this.imageService.uploadImage(updateUserDto.avatar)];
                        case 2:
                            image = _a.sent();
                            return [4 /*yield*/, bcrypt.hash(updateUserDto.password, 10)];
                        case 3:
                            password = _a.sent();
                            return [4 /*yield*/, this.userModel.findByIdAndUpdate(id, __assign(__assign({}, updateUserDto), { avatar: image, password: password }), { new: true })];
                        case 4:
                            updatedUser = _a.sent();
                            if (!updatedUser)
        ...
        UsersService_1.prototype.profile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var token, decodedToken, userId, user, error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            if (!req.headers.authorization) {
                                throw new common_1.BadRequestException("Token don't provided");
                            }
                            token = req.headers.authorization.split(' ')[1];
                            return [4 /*yield*/, this.jwtService.verify(token, {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.userModel.findById(userId).select('-password')];
                        case 2:
                            user = _a.sent();
                            if (!user)
                                throw new common_1.NotFoundException('User not found');
        ...
        UsersService_1.prototype.validateToken = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
