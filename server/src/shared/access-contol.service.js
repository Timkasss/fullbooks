...
var AccessControlService = function () {
    ...
    var AccessControlService = _classThis = /** @class */ (function () {
        function AccessControlService_1() {
            this.roleHierarchy = new Map();
            this.priority = 1;
            this.buildRoleHierarchy([role_enum_1.Role.USER, role_enum_1.Role.ADMIN]);
        }
        AccessControlService_1.prototype.buildRoleHierarchy = function (roles) {
            var _this = this;
            roles.forEach(function (role) {
                _this.roleHierarchy.set(role, _this.priority);
                _this.priority++;
            });
        };
        AccessControlService_1.prototype.isAuthorized = function (_a) {
            var currentRole = _a.currentRole, requiredRole = _a.requiredRole;
            var currentPriority = this.roleHierarchy.get(currentRole);
            var requiredPriority = this.roleHierarchy.get(requiredRole);
