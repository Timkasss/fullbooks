...
var UpdateBookDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _title_decorators = [(0, swagger_1.ApiProperty)({ description: 'Title of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Title must be a string' }), (0, class_validator_1.IsOptional)()];
            _subTitle_decorators = [(0, swagger_1.ApiProperty)({ description: 'Subtitle of the book', type: String }), (0, class_validator_1.IsString)({ message: 'SubTitle must be a string' }), (0, class_validator_1.IsOptional)()];
            _authors_decorators = [(0, swagger_1.ApiProperty)({ description: 'Authors of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Authors must be a string' }), (0, class_validator_1.IsOptional)()];
            _genre_decorators = [(0, swagger_1.ApiProperty)({ description: 'Genre of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Genre must be a string' }), (0, class_validator_1.IsOptional)()];
            _grade_decorators = [(0, swagger_1.ApiProperty)({ description: 'Rating of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Rating must be a string' }), (0, class_validator_1.IsOptional)()];
            _language_decorators = [(0, swagger_1.ApiProperty)({ description: 'Language of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Language must be a string' }), (0, class_validator_1.IsOptional)()];
            _publishedDate_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Published date of the book',
                    type: String
                }), (0, class_validator_1.IsString)({ message: 'PublishedDate must be a string' }), (0, class_validator_1.IsOptional)()];
            _publisher_decorators = [(0, swagger_1.ApiProperty)({ description: 'Publisher of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Publisher must be a string' }), (0, class_validator_1.IsOptional)()];
            _description_decorators = [(0, swagger_1.ApiProperty)({ description: 'Description of the book', type: String }), (0, class_validator_1.IsString)({ message: 'Description must be a string' }), (0, class_validator_1.IsOptional)()];
            _pages_decorators = [(0, swagger_1.ApiProperty)({ description: 'Count of pages', type: String }), (0, class_validator_1.IsString)({ message: 'Pages must be a string' }), (0, class_validator_1.IsOptional)()];
            _image_decorators = [(0, swagger_1.ApiProperty)({ description: 'URL to the image of the book', type: String }), (0, class_validator_1.IsOptional)()];
